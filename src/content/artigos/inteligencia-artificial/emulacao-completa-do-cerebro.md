...
- processos de tomada de decisão
 A emulação não precisaria necessariamente reproduzir cada átomo do cérebro.
...
- possíveis estados químicos e elétricos
 Um cérebro humano possui uma quantidade gigantesca de estruturas interligadas.
...
- interação com o ambiente
 Uma cópia apenas do cérebro talvez não fosse suficiente para reproduzir completamente uma pessoa.
...
- modificação do ambiente virtual
 Hoje, um ataque pode roubar documentos ou credenciais.
...
- mecanismos de segurança
 Isso criaria uma dependência profunda entre mente e infraestrutura.
...
- validar se a emulação realmente funciona
 Mesmo que conseguíssemos mapear todas as conexões, ainda precisaríamos saber como transformar esse mapa em atividade mental.
